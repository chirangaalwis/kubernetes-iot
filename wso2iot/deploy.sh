...
echo "Deploying IOT database Service..."
kubectl create -f "mysql-iotdb-service.yaml"

echo "Deploying IOT database Replication Controller..."
kubectl create -f "mysql-iotdb-controller.yaml"
