...
DROP DATABASE IF EXISTS prod_wso2_user_db;
DROP DATABASE IF EXISTS prod_wso2_reg_db;
DROP DATABASE IF EXISTS prod_wso2_am_db;
DROP DATABASE IF EXISTS prod_wso2_appm_db;
DROP DATABASE IF EXISTS prod_wso2_cdm_db;

CREATE DATABASE prod_wso2_user_db;
CREATE DATABASE prod_wso2_reg_db;
CREATE DATABASE prod_wso2_am_db;
CREATE DATABASE prod_wso2_appm_db;
CREATE DATABASE prod_wso2_cdm_db;

CREATE USER IF NOT EXISTS 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON prod_wso2_user_db.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON prod_wso2_reg_db.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON prod_wso2_am_db.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON prod_wso2_appm_db.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON prod_wso2_cdm_db.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';

USE prod_wso2_user_db;
